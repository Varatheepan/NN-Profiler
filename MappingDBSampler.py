...
def MappingDataExtractor(args, ModeS, Parameters, ObjStages, mapping, image):
    try:
        global Running_active
        ...
        if args.eval_thr:
            ...
            InferenceCount = {model_name:{} for model_name in model_list}
            for model_name in ObjStages.keys():
                for stage in ObjStages[model_name]:
                    InferenceCount[model_name][stage.device.type] = stage.infCount
            ...
            print("Inference counts: ", InferenceCount)
        ...
        return InferenceCount, power_stats
