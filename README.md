...
- imgs: A comma seperated list of images to run the experimets. Images should be stored in data imagenet directory.

Tegratstats related parameters

- tgr_params: A space seperatedlist of parameters from the defaults list of parameters to extract from tegratstats.
...
- tgr_smpl_boundry: Time window allowed for the tegratstats to stablize for the layer being experimented (default=1).
