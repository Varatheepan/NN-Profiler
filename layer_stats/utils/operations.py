...
class CustomOpExecutor:
    ...
    @staticmethod
    @torch.no_grad()
    def _vit_pre_out_op(x: torch.Tensor):
        return x[:, 0]
...
def database_spawn(preprocess: bool = False, pretrained: bool = False, verbose: bool = False, jetson_device: str = "Tx2"):
    ...
    op_executor.register_family_operation("densenet", CustomOpExecutor._densenet_op)
    op_executor.register_family_operation("efficientnet", CustomOpExecutor._efficientnet_op)
    op_executor.register_family_operation("googlenet", CustomOpExecutor._googlenet_prep_op)
    op_executor.register_family_operation("googlenet", CustomOpExecutor._googlenet_post_op)
    op_executor.register_family_operation("inception", CustomOpExecutor._inception_prep_op)
    op_executor.register_family_operation("inception", CustomOpExecutor._inception_post_op)
    op_executor.register_family_operation("mnasnet", CustomOpExecutor._mnasnet_op)
    op_executor.register_family_operation("mobilenet_v2", CustomOpExecutor._mobilenet_v2_op)
    op_executor.register_family_operation("mobilenet_v3", CustomOpExecutor._mobilenet_v3_op)
    op_executor.register_family_operation("regnet_x", CustomOpExecutor._regnet_op)
    op_executor.register_family_operation("regnet_y", CustomOpExecutor._regnet_op)
    op_executor.register_family_operation("resnet", CustomOpExecutor._resnet_op)
    op_executor.register_family_operation("resnext", CustomOpExecutor._resnet_op)
    op_executor.register_family_operation("shufflenet_v2", CustomOpExecutor._shufflenet_v2_op)
    op_executor.register_family_operation("vgg", CustomOpExecutor._vgg_op)
    op_executor.register_family_operation("vit", CustomOpExecutor._vit_pre_out_op)
